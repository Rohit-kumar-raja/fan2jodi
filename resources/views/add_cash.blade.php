                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 mb-4 ">
                        <div class="single-stream-schedule-box white-bg rounded  ">
                                ...
                                <button type="button"  class="btn btn-md mr-20 text-white blue-bg mt-30" onclick="handleAppendCash(200)">₹200 </button>
                                <button  type="button" class="btn btn-md mr-20 text-white blue-bg mt-30" onclick="handleAppendCash(500)">₹500 </button>
                            </div>
                        </div>
